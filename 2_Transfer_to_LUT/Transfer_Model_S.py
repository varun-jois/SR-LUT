...
id = 'id08911'  # S, colors, id04119, id07354, id08911

# USER PARAMS
UPSCALE = 4                  # upscaling factor
MODEL_PATH = f'/home/varun/fvc/SR-LUT/1_Train_deep_model/checkpoint/{id}/model_G_i100.pth'    # Trained SR net params  "./Model_S.pth"
