...
### USER PARAMS ###
id = 'id08911'  #  id04119, colors, id07354, id08911
...
START_ITER = 200_000      # Set 0 for from scratch, else will load saved params and trains further
...
I_SAVE = 20       # save models every N iteration
...
def SaveCheckpoint(i, best=False):
    ...
    torch.save(model_G, f'{save_model}/model_G_i{i}.pth')
    torch.save(opt_G, f'{save_model}/opt_G_i{i}.pth')
